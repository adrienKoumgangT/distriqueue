...
During the development of TaskForce, a Large Language Model (Google Gemini\cite{gemini}) was utilized as an interactive pair-programming and architectural assistant.
